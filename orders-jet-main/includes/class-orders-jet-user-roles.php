...
class Orders_Jet_User_Roles {
    ...
    public function __construct() {
        ...
        // Also register roles on init to ensure they're always available
        add_action('init', array($this, 'ensure_roles_exist'), 1);
    ...
    public function ensure_roles_exist() {
        // Check if our custom roles exist, if not, register them
        if (!get_role('oj_kitchen') || !get_role('oj_manager') || !get_role('oj_waiter')) {
            $this->register_roles();
            oj_debug_log('Orders Jet roles registered on init', 'USER_ROLES');
        }
    }
    ...
    public function register_roles() {
        ...
        oj_debug_log('Custom user roles registered successfully', 'USER_ROLES');
    }
    ...
    public static function remove_roles() {
        ...
        oj_debug_log('Custom user roles removed', 'USER_ROLES');
    }
    ...
    public function assign_user_role($user_id, $role_slug) {
        ...
        oj_debug_log("Assigned role {$role_slug} to user {$user_id}", 'USER_ROLES');
